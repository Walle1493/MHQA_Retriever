...
from data import convert_examples_to_features, processors
# from models.bert.modeling_bert import BertForRetriever

try:
    from torch.utils.tensorboard import SummaryWriter
except ImportError:
    from tensorboardX import SummaryWriter
from evaluation import retriever_metrics
import pdb
...
def main():
    ...
    parser.add_argument(
        ...
        default=2,
        type=int,
        help="Retrieve for top k sentences.",
    )
    ...
    label_list = processor.get_labels() # [0, 1, ..., 9]
